...
class signalFileReader{
	...
	private:
		...
		void measureFile(int fileNumber, bool* foundFirstBlock);
		...
		*/
		...
		int sequentNumberFromGidrophoneNumber(int gidrophoneNumber);
	...
	public:
		...
		std::vector<int>* data(qint64 start, qint64 length, int gidrophoneNumber);
